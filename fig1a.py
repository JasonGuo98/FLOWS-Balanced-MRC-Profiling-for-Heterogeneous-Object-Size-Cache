...
if __name__ == "__main__":
    ...
    ContentPop_mrc_file = f"./results/profile_res-{trace_name}-SHARDS-FIX_RATE-0.01-bin-MAEQ-1.csv"
    ...
    ContentPop_mrc_file = f"./results/profile_res-{trace_name}-SHARDS-FIX_RATE-0.01-bin-MAEQ-3.csv"
    _, BMRC3, OMRC3= load_csv_mrc_file(ContentPop_mrc_file)

    bmrcs = [real_BMRC, BMRC1, BMRC2, BMRC3]
    omrcs = [real_OMRC, OMRC1, OMRC2, OMRC3]
    names = ["Exact", "SHARDS-1", "SHARDS-2", "SHARDS-3"]
    save_name = "plots/fig1a.pdf"
